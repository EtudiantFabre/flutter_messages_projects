...
final List<Email> emails = [
  ...
  Email(
      ...
      attachments: [const Attachment(url: 'assets/thumbnail.jpg')]),
  Email(
      sender: user_4,
      recipients: [],
